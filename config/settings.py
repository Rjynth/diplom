...
SECRET_KEY = 'django-insecure-@^u($kpj*2ky2+c7ly&^=ii1%t^ikh-jb@%4r6cs#d_gtt!%+s'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'user': '20/minute',  # авторизованным — не более 5 запросов в минуту
        'anon': '15/minute',  # анонимным — не более 2 запросов в минуту
    },
